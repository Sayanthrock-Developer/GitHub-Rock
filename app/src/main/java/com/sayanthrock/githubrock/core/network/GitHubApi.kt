...
interface GitHubRestApi {
    ...
    @GET("search/code") suspend fun searchCode(@Query("q") query: String, @Query("per_page") perPage: Int = 30, @Query("page") page: Int = 1): CodeSearchResponse
    @GET("search/issues") suspend fun searchIssues(@Query("q") query: String, @Query("sort") sort: String = "updated", @Query("order") order: String = "desc", @Query("per_page") perPage: Int = 30, @Query("page") page: Int = 1): IssueSearchResponse
    @GET("search/commits") suspend fun searchCommits(@Query("q") query: String, @Query("sort") sort: String = "committer-date", @Query("order") order: String = "desc", @Query("per_page") perPage: Int = 30, @Query("page") page: Int = 1): CommitSearchResponse
    ...
    @GET("repos/{owner}/{repo}/readme") suspend fun readme(@Path("owner") owner: String, @Path("repo") repo: String, @Query("ref") ref: String? = null): ContentEntry
