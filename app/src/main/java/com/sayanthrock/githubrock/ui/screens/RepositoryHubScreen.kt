    ...
    Scaffold(
        ...
        Column(Modifier.fillMaxSize().padding(padding)) {
            RepositoryHubContent(
                ...
                whatsNewTranslationTarget = state.whatsNewTranslationTarget,
                translatedReleaseTitle = state.translatedReleaseTitle,
                translatedReleaseBlocks = state.translatedReleaseBlocks,
                whatsNewTranslationLoading = state.whatsNewTranslationLoading,
                whatsNewTranslationError = state.whatsNewTranslationError,
                onSelectWhatsNewLanguage = viewModel::selectWhatsNewTranslationLanguage,
                onTranslateWhatsNew = viewModel::translateWhatsNew,
                onClearWhatsNewTranslation = viewModel::clearWhatsNewTranslation,
