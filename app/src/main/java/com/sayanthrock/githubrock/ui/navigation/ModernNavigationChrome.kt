...
/**
 * GitHub Rock's single adaptive navigation surface.
 *
 * The phone treatment is intentionally floating and capsule-shaped: a compact,
 * iPhone-inspired interaction model without copying a platform component. It uses
 * the app's Material 3/system color scheme so the surface adapts automatically.
 */
@Composable
