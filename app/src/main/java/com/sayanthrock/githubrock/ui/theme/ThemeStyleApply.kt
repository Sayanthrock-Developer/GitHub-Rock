...
internal fun ColorScheme.applyRockStyle(style:ThemeStyle,dark:Boolean):ColorScheme=when(style){
...
internal fun ColorScheme.applyTrueBlack(dark:Boolean,enabled:Boolean)=if(!dark||!enabled)this else copy(background=Color.Black,surfaceContainerLowest=Color.Black)
