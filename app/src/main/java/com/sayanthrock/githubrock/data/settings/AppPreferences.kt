...
class AppPreferences @Inject constructor(@ApplicationContext private val context: Context) {
    ...
    val translationLanguage: Flow<String> = context.dataStore.data.map { it[TRANSLATION_LANGUAGE] ?: "en" }

    suspend fun setTranslationLanguage(language: String) {
        val normalized = language.trim().lowercase().takeIf { it.isNotBlank() } ?: return
        context.dataStore.edit { it[TRANSLATION_LANGUAGE] = normalized }
    }
    ...
    private companion object {
        ...
        val WORKFLOW_PREVIEW = booleanPreferencesKey("workflow_preview"); val WORKFLOW_STEP_DETAILS = booleanPreferencesKey("workflow_step_details"); val STATUS_COLORS = booleanPreferencesKey("status_colors"); val ACTIONS_CONTROLS = booleanPreferencesKey("actions_controls"); val REPOSITORY_MANAGER = booleanPreferencesKey("repository_manager"); val FILE_TOOLS = booleanPreferencesKey("file_tools"); val COMPACT_CARDS = booleanPreferencesKey("compact_cards"); val REDUCE_MOTION = booleanPreferencesKey("reduce_motion"); val BIOMETRIC_LOCK = booleanPreferencesKey("biometric_lock"); val FAVORITE_REPOSITORIES = stringSetPreferencesKey("favorite_repositories"); val REPOSITORY_SEARCH_HISTORY = stringPreferencesKey("repository_search_history"); val TRANSLATION_LANGUAGE = stringPreferencesKey("translation_language")
